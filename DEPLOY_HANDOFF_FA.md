...
- **قاعدهٔ «تسویه از دفتر» (از 2026-09-26):** «هزینه بروز باقیمانده» و «بودجه موردنیاز تا
  ...
  **تجهیزات**: مبلغ هر فاکتور بر قیمتِ معتبر در **تاریخ همان فاکتور** (`price_versions` با
  ...
  دست آید، و `(بازنگری‌شده − تسویه‌شده) × قیمت روز` باقیمانده است. **نیروی انسانی** دقیقاً
  مثل تجهیزات (مبلغ ÷ نرخ همان تاریخ). برای **هزینهٔ عمومی**: `برآورد − پرداختی`. پیشرفت
  فقط «ارزش روز کار انجام‌شده» را می‌سازد و در هیچ باقیمانده‌ای نقش ندارد. پرداخت نیرو یا
  تجهیزاتی که در تاریخش هیچ قیمتی نبوده و برآورد هم قیمت ندارد هشدار `INVOICE_PRICE_MISSING`
