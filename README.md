...
پوسته توسعه Frontend ماژول مالی BAMBO بر اساس PRD نسخه ۱.۰ و Integration Kit نسخه ۱.۰.۰ است.
...
پورت اختصاصی این پروژه `43127` است تا با پروژه‌های دیگر تداخل نداشته باشد. سرور را از ریشه مخزن اجرا کنید:
