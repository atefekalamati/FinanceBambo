...
class InvoiceResponse(ApiModel):
 ...
 @classmethod
 def from_domain(cls,v):return cls(invoice_number=format_invoice_number(v.invoice_seq),**{k:x for k,x in v.__dict__.items() if k in cls.model_fields and k!="invoice_number"})
