...
from ..domain.resources import FinanceRecordNotFound, UnitMismatch, UnitNotFound
from ..domain.unit_registry import UNIT_REGISTRY, units_are_compatible
class UnitConversionService:
 ...
 def _validate_units(self,source_unit,target_unit,dimension):
  if source_unit not in UNIT_REGISTRY or target_unit not in UNIT_REGISTRY:
   raise UnitNotFound("unit is not registered")
  if not units_are_compatible(source_unit,target_unit,dimension):
   raise UnitMismatch("unit conversion dimension mismatch")
