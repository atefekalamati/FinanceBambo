...
class FinanceLiveReportService:
    ...
    async def issue(self,scope,reporting_date,progress_snapshot_id=None):
        ...
        payload=_json_value({"reportingDate":reporting_date,"settingsId":data["settings_id"],"grossBuiltArea":data["gross_area"],
            ...
            "missingPriceCount":report.missing_price_count,"missingEstimateLineCount":report.missing_estimate_line_count,"excludedEstimateLineCount":report.excluded_estimate_line_count,"computedLineCount":report.computed_line_count,"totalLineCount":report.total_line_count,"requiredLineCount":report.required_line_count,
