...
RESOURCES = [
    ...
    (UUID("20000000-0000-4000-8000-000000000005"), "work", "LAB-FORM",
     "اکیپ قالب‌بندی", "person_hour", "labor_time", "res-formwork-team"),
    (UUID("20000000-0000-4000-8000-000000000006"), "work", "LAB-REBAR",
     "اکیپ آرماتوربندی", "person_hour", "labor_time", "res-rebar-team"),
    (UUID("20000000-0000-4000-8000-000000000007"), "work", "EQ-CRANE",
     "جرثقیل برجی", "hour", "time", "res-crane"),
    (UUID("20000000-0000-4000-8000-000000000008"), "work", "EQ-EXCAV",
