...
| | |
|---|---|
| آدرس دمو | **`http://127.0.0.1:8010`** |
| دیتابیس | `bambo_finance_integration_demo` روی `127.0.0.1:5432` |

اگر پورت ۸۰۱۰ مشغول باشد، میزبان **متوقف می‌شود و پیام می‌دهد** — و **هیچ پروسه‌ای را
نمی‌کُشد**، چون هرچه آنجا گوش می‌دهد را این برنامه راه نینداخته و نمی‌داند چیست.

عمداً به پورت دیگری هم فرار نمی‌کند: دمویی که بی‌صدا جابه‌جا شود، دمویی است که نمی‌شود
برایش دستورالعمل نوشت.

پورت دیگر، اگر لازم شد:
