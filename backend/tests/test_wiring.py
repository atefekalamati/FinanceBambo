...
class WiringTests(unittest.TestCase):
    ...
    def test_openapi_matches_runtime_pagination_filters_and_new_dto_fields(self):
        ...
        # The price import form carries the file alone; currencyUnit is an optional audit note,
        # because normalization reads each row's own mandatory currency column.
        ...
        self.assertIn("currencyUnit",price_import["properties"])
