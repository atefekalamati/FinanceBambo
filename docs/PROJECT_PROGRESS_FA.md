...
| شاخص | وضعیت فعلی |
|---|---|
| پیشرفت وزنی Frontend تا نسخه Mock-complete | حدود ۴۸٪ |
| فاز فعال | فاز ۴ — Progress Snapshot و Override |
| کار بعدی قطعی | Manual Override مقدار پیشرفت با دلیل و Permission |
| تست‌های فعلی | ۴۹ تست موفق |
...
| ۴. Progress Snapshot و Override | ۱۰٪ | در حال انجام | حدود ۶۰٪ | حدود ۶٪ |
...
- [ ] `P0` Manual Override با دلیل و Permission
- [x] `P0` نمایش computed value کنار override value موجود در Feed
- [ ] `P1` هشدار مقدار اجرا بیشتر از برآورد
