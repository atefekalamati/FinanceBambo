...
| --- | --- | --- | --- |
| امور مالی | `#finance/finance` | اقلام و برآورد، قیمت روز، پیشرفت، ورودی تصویر و صدا، بررسی هوشمند فاکتور، تاریخچه تغییرات، تنظیمات مالی پروژه | ادمین؛ جایی که اعداد ساخته می‌شوند |
| گزارش مالی | `#finance/finance-report` | گزارش وضعیت مالی، گزارش دوره‌ای، فاکتورها، تنظیمات نمایش | مشتری؛ آنچه اعداد از آب درآمده‌اند |
...
- `#finance/report-settings` نمایش‌گر همان صفحه تنظیمات است با `surface: "report"`: فقط واحد نمایش مبلغ و فهرست دسترسی‌های مالی. این یک بررسی مجوز نیست؛ Backend همچنان PATCH بدون `finance.edit` را رد می‌کند.
