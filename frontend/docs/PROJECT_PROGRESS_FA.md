...
| شاخص | وضعیت فعلی |
|---|---|
| پیشرفت وزنی Frontend تا نسخه Mock-complete | حدود ۷۶٪ |
| فاز فعال | فاز ۶ — فایل، OCR/Voice و AI Review |
| کار بعدی قطعی | تکمیل UX شکست Provider و اتصال فاکتور تأییدشده استخراجی به فهرست فاکتورها |
| تست‌های فعلی | ۸۴ تست موفق |
...
| ۶. فایل، OCR/Voice و AI Review | ۱۰٪ | در حال انجام | ۸۰٪ | ۸٪ |
