...
| شاخص | وضعیت فعلی |
|---|---|
| پیشرفت وزنی Frontend تا نسخه Mock-complete و اتصال فعلی | حدود ۸۴٪ |
| فاز فعال | فاز ۷ — خلاصه مالی، گزارش و Snapshot |
| کار بعدی قطعی | Breakdown نوع قلم و نمودارهای داخلی همراه جدول جایگزین |
| تست‌های فعلی | ۹۰ تست موفق |
...
| ۷. خلاصه مالی، گزارش و Snapshot | ۱۲٪ | در حال انجام | ۲۵٪ | ۳٪ |
