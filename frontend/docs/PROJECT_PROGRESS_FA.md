...
| شاخص | وضعیت فعلی |
|---|---|
| پیشرفت وزنی Frontend تا نسخه Mock-complete | حدود ۵۵٪ |
| فاز فعال | فاز ۵ — فاکتور دستی و چرخه عمر سند |
| کار بعدی قطعی | فرم سه‌مرحله‌ای فاکتور: سربرگ، خطوط و پیش‌نمایش |
| تست‌های فعلی | ۶۱ تست موفق |
...
| ۵. فاکتور دستی و چرخه عمر سند | ۱۶٪ | در حال انجام | حدود ۲۰٪ | حدود ۳٪ |
