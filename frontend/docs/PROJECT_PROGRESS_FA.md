...
| شاخص | وضعیت فعلی |
|---|---|
| پیشرفت وزنی Frontend تا نسخه Mock-complete | حدود ۶۶٪ |
| فاز فعال | فاز ۵ — فاکتور دستی و چرخه عمر سند |
| کار بعدی قطعی | Void/Reversal و Corrective با سند مرتبط و دلیل ممیزی |
| تست‌های فعلی | ۷۱ تست موفق |
...
| ۵. فاکتور دستی و چرخه عمر سند | ۱۶٪ | در حال انجام | حدود ۸۵٪ | حدود ۱۴٪ |
