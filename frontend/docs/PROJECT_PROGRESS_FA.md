...
| شاخص | وضعیت فعلی |
|---|---|
| پیشرفت وزنی Frontend تا نسخه Mock-complete | حدود ۵۰٪ |
| فاز فعال | فاز ۴ — Progress Snapshot و Override |
| کار بعدی قطعی | تکمیل نمایش مقدار و درصد انحراف اجرای بیشتر از برآورد |
| تست‌های فعلی | ۵۴ تست موفق |
| صفحات فعال | امور مالی، تنظیمات مالی، اقلام و متره، قیمت‌ها و خوراک پیشرفت |
...
| ۴. Progress Snapshot و Override | ۱۰٪ | در حال انجام | حدود ۸۰٪ | حدود ۸٪ |
| ۵. فاکتور دستی و چرخه عمر سند | ۱۶٪ | شروع‌نشده | ۰٪ | ۰٪ |
...
- [ ] `P1` نمایش مقدار و درصد انحراف هنگام اجرای بیشتر از برآورد؛ هشدار و الزام دلیل پیاده شده است

## فاز ۵ — فاکتور دستی

وضعیت: `شروع‌نشده`

- [ ] `P0` فهرست، فیلتر، Pagination و جزئیات فاکتور
- [ ] `P0` فرم سه‌مرحله‌ای Header → Lines → Preview
- [ ] `P0` خطوط چندگانه و اتصال به Estimate Line/General Cost
- [ ] `P0` تخفیف، مالیات، حمل و سایر هزینه‌ها
- [ ] `P0` Duplicate warning و دلیل ادامه
