...
| شاخص | وضعیت فعلی |
|---|---|
| پیشرفت وزنی Frontend تا نسخه Mock-complete | حدود ۶۴٪ |
| فاز فعال | فاز ۵ — فاکتور دستی و چرخه عمر سند |
| کار بعدی قطعی | Confirm با Modal، قفل سند و کنترل submitter؛ فعال‌سازی Permission وابسته به تصمیم BAMBO |
| تست‌های فعلی | ۶۹ تست موفق |
...
| ۵. فاکتور دستی و چرخه عمر سند | ۱۶٪ | در حال انجام | حدود ۷۰٪ | حدود ۱۱٪ |
