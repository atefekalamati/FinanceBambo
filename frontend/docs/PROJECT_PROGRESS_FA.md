...
| شاخص | وضعیت فعلی |
|---|---|
| پیشرفت وزنی Frontend تا نسخه Mock-complete | حدود ۶۰٪ |
| فاز فعال | فاز ۵ — فاکتور دستی و چرخه عمر سند |
| کار بعدی قطعی | هشدار تکراری با نمایش سند مشابه و دلیل اجباری ادامه |
| تست‌های فعلی | ۶۶ تست موفق |
...
| ۵. فاکتور دستی و چرخه عمر سند | ۱۶٪ | در حال انجام | حدود ۵۰٪ | حدود ۸٪ |
